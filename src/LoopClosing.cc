...
bool LoopClosing::NewDetectCommonRegions()
{
...
#endif
        cout << "Merge or Loop Detected" << endl;
        mpKeyFrameDB->add(mpCurrentKF);
        return true;
    }
    ...
    if(mbMergeDetected || mbLoopDetected)
    {
        cout << "Merge or Loop Detected via bow" << endl;
        return true;
    }
                                             ...
                                             int &nNumCoincidences, std::vector<MapPoint*> &vpMPs, std::vector<MapPoint*> &vpMatchedMPs)
{
    ...
    // std::cout << "BoW candidates: There are " + to_string(vpBowCand.size()) + " possible candidates " << std::endl;

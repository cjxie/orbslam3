...
{  
    ...
    // LoadImages(pathCam0, pathCam1, pathTimeStamps, vstrImageLeft[0], vstrImageRight[0], vTimestampsCam[0]);
    ...
    ORB_SLAM3::System SLAM(argv[1],argv[2],ORB_SLAM3::System::STEREO, bVisualization);
